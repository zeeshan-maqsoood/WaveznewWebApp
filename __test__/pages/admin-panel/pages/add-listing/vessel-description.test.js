...
import VesselDescription from "../../../../../pages/admin-panel/pages/add-listing/vessel-description"
...
describe("Vessel Description Component", () => {
    // 1
    it("renders", async () => {
        ...
        expect(container.innerHTML).toMatch(/Vessel Description/i)
