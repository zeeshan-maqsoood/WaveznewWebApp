...
const EndVerification = (props) => {
    ...
    const onNextClick = () => {
        ...
        correctOtp?.endCode
            ? (otp === correctOtp?.endCode ? endTrip() : setErrors(true))
                ...
                <div className={classes.subContainer}>
                    <div className={classes.content}>
                        <div className={classes.subContent}>
                            <h1 className={classes.header}>{t.postdepartureChecklist.endVerification.otpHeader}</h1>
                            <p>
                        ...
                        <FormHelperText error className={classes.errorText}> {errors ? t.postdepartureChecklist.endVerification.otpNoMatch : null} </FormHelperText>
