...
const startSuccessful = ({ }) => {
    ...
    const onNextClick = () => {
        router.push(`/trips/${  router.query?.id  }/started`)
    }
                ...
                <div className={classes.subContainer}>
                    <div className={classes.content}>
                        <div className={classes.subContent}>
                            <h1 className={classes.header}>{t.predepartureChecklist.startVerification.successHeader}</h1>
                        </div>
                        <br />
                        <div className={classes.subContent}>
...
export default startSuccessful
